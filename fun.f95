...
!-------------------------------------------------------------------------------
  ...
  ! - Generate a script for Python in case of drawing cross section graphs at the end of the run.
  SUBROUTINE Graphs
    OPEN(94,form='formatted',file='graphs.py')
    WRITE(94,'(a)') 'from pylab import *'
    WRITE(94,'(a)') 'import matplotlib.pyplot as plt'
    WRITE(94,'(a)') 'f = open("Cross_sections.out")'
    WRITE(94,'(a)') 'heading = f.readline()'
    WRITE(94,'(a)') 'Energy = []'
    WRITE(94,'(a)') 'Elastic_CS = []'
    WRITE(94,'(a)') 'Absorption_CS = []'
    WRITE(94,'(a)') 'Total_CS = []'
    WRITE(94,'(a)') 'for line in f:'
    WRITE(94,'(a)') '   dat = line.split()'
    WRITE(94,'(a)') '   Energy.append(float(dat[0]))'
    WRITE(94,'(a)') '   Elastic_CS.append(float(dat[1]))'
    WRITE(94,'(a)') '   Absorption_CS.append(float(dat[2]))'
    WRITE(94,'(a)') '   Total_CS.append(float(dat[4]))'
    WRITE(94,'(a)') 'f.close()'
    WRITE(94,'(a)') 'fig1,axes = plt.subplots()'
    WRITE(94,'(a)') 'axes.plot(Energy, Elastic_CS, "x--b")'
    WRITE(94,'(a)') 'axes.set_xlabel("Energy (MeV)")'
    WRITE(94,'(a)') 'axes.set_ylabel("Cross section (mb)")'
    WRITE(94,'(a)') 'axes.set_title("Elastic cross section")'
    WRITE(94,'(a)') 'axes.grid(True)'
    WRITE(94,'(a)') 'fig1.savefig("Elastic_CS.eps", format="eps")'
    WRITE(94,'(a)') '##################################################'
    WRITE(94,'(a)') 'fig2,axes = plt.subplots()'
    WRITE(94,'(a)') 'axes.plot(Energy, Absorption_CS, "*--r")'
    WRITE(94,'(a)') 'axes.set_xlabel("Energy (MeV)")'
    WRITE(94,'(a)') 'axes.set_ylabel("Cross section (mb)")'
    WRITE(94,'(a)') 'axes.set_title("Absorption cross section")'
    WRITE(94,'(a)') 'axes.grid(True)'
    WRITE(94,'(a)') 'fig2.savefig("Absorption_CS.eps", format="eps")'
    WRITE(94,'(a)') '##################################################'
    WRITE(94,'(a)') 'fig3,axes = plt.subplots()'
    WRITE(94,'(a)') 'axes.plot(Energy, Total_CS, "x-.b")'
    WRITE(94,'(a)') 'axes.set_xlabel("Energy (MeV)")'
    WRITE(94,'(a)') 'axes.set_ylabel("Cross section (mb)")'
    WRITE(94,'(a)') 'axes.set_title("Total cross section")'
    WRITE(94,'(a)') 'axes.grid(True)'
